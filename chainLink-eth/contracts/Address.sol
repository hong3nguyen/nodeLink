...
contract getAddressTemplate is ChainlinkClient {
  ...
  constructor() {
    ...
    setChainlinkToken(0xB6eFca1fcDDbb3E1950d1AaC422f9CC913Cc602e); // need to make a MOCKLINK for that to convert from Eth to LINK
    setChainlinkOracle(0x26fd5013A99bA26505C03D47D0D61Cc66062f071);//(0x1db329cDE457D68B872766F4e12F9532BCA9149b);
